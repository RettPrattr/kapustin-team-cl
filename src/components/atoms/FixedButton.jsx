...
function FixedButton(props) {
    ...
    const { type, text, href } = props.props
    ...
    if ( type === 1 ) {
        return (
            <div className={'fixedButton fixedButton-' + type + ' flex flex-row cb-mid'} >
                    <Link href={href} className='container сursor-pointer'>
    ...
    if ( type === 2 ) {
        return (
            <div className={'fixedButton fixedButton-' + type + ' flex flex-row'} >
               <Button
                    type={1}
